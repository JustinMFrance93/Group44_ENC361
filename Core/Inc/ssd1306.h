 ...
 *
 * Modifications for ENCE361 by F. Youssif:
 * - Fix typo: make the "c" in "stm32c0xx_hal.h" lower case.
 * - Improve performance of I2C comms by using the DMA
 * 		and interrupt-driven page updates.
 */
